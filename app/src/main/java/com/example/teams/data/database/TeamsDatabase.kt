...
@Database(entities = [Candidate::class, Team::class], version = 9, exportSchema = false)
            ...
            INSTANCE?.let { database ->
                scope.launch {
                    ...
                    candidate = Candidate(
                        firstName = "Domini",
                        lastName = "Meah",
                        email = "dmeah1@msu.edu",
                        gender = "Polygender",
                        age = 28,
                        jobTitle = "Physical Therapy Assistant",
                        quote = "Synchronised upward-trending installation",
                        ...
                        profilePicture = "https://robohash.org/quaedolorest.png?size=2000x2000&set=set1",
                        idTeam = 1
                    )
                    candidateDao.insert(candidate)
                    candidate = Candidate(
                        firstName = "Hefn",
                        lastName = "Zbbepebsg",
                        email = "hzbbepebsg0@algvzrf.pbz",
                        gender = "Srznyr",
                        age = 20,
                        jobTitle = "IC Dhnyvgl Pbageby",
                        quote = "Zhygv-yngreny erfcbafvir fbsgjner",
                        bio = "hygevprf cunfryyhf vq fncvra va fncvra vnphyvf pbathr ivinzhf zrghf neph nqvcvfpvat zbyrfgvr uraqerevg ng ihychgngr ivgnr avfy nrarna yrpghf cryyragrfdhr rtrg ahap qbarp dhvf bepv rtrg bepv iruvphyn pbaqvzraghz phenovghe va yvoreb hg znffn ibyhgcng pbainyyvf zbeov bqvb bqvb ryrzraghz rh vagreqhz rh gvapvqhag va yrb znrpranf chyivane ybobegvf rfg cunfryyhf fvg nzrg reng ahyyn grzchf ivinzhf va sryvf rh fncvra phefhf irfgvohyhz cebva rh zv ahyyn np ravz va grzcbe ghecvf arp rhvfzbq fpryrevfdhr dhnz ghecvf nqvcvfpvat yberz ivgnr znggvf avou yvthyn arp frz qhvf nyvdhnz pbainyyvf ahap cebva ng ghecvf n crqr cbfhrer abahzzl vagrtre aba iryvg qbarp qvnz ardhr irfgvohyhz rtrg ihychgngr hg hygevprf iry nhthr irfgvohyhz nagr vcfhz cevzvf va snhpvohf bepv yhpghf rg hygevprf cbfhrer phovyvn phenr qbarp cunergen zntan irfgvohyhz nyvdhrg hygevprf reng gbegbe fbyyvpvghqva zv fvg nzrg ybobegvf fncvra fncvra aba zv vagrtre np ardhr qhvf ovoraqhz zbeov aba dhnz arp qhv yhpghf ehgehz ahyyn gryyhf va fntvggvf qhv iry avfy qhvf np avou shfpr ynphf chehf",
                        profilePicture = "https://robohash.org/nihilreprehenderitquia.png?size=2000x2000&set=set1",
                        idTeam = 2)
                    candidateDao.insert(candidate)
                    candidate = Candidate(
                        firstName = "Qbzvav",
                        lastName = "Zrnu",
                        email = "qzrnu1@zfh.rqh",
                        gender = "Cbyltraqre",
                        age = 28,
                        jobTitle = "Culfvpny Gurencl Nffvfgnag",
                        quote = "Flapuebavfrq hcjneq-geraqvat vafgnyyngvba",
                        ...
                        profilePicture = "https://robohash.org/commodiabet.png?size=2000x2000&set=set1",
                        idTeam = 2)
                    candidateDao.insert(candidate)
                }
            }
